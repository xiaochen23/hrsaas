<template>
  <div class="dashboard-container">
    ...
    <el-dialog title="分配权限" :visible="showPermDialog" @close="btnPermCancel">
      <!-- 权限是一棵树 -->
      <!-- check-strictly="true" 表示 父子时不互相关联 -->
      <!-- id作为唯一标识 -->
      <el-tree
        ref="permTree"
        :data="permData"
...
export default {
  ...
  methods: {
    ...
    // 弹出层 获取权限点数据 再点击的时候调用 获取权限点数据
    async assignPerm(id) {
      this.permData = tranListToTreeData(await getPermissionList(), '0') // 将list数据转化为树形数据
      this.roleId = id
      // 获取这个id的权限点
